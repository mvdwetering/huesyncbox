...
class HueSyncBoxSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def __init__(self, coordinator:HueSyncBoxCoordinator, entity_description:HueSyncBoxSwitchEntityDescription):
        ...
        self._attr_unique_id = f"{self.entity_description.key}_{self.coordinator.api.device.unique_id}"
